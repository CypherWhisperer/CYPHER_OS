# ──────────────────────────────────────────────────────────────────────────────
# src/dev/languages/php_system.nix
# ──────────────────────────────────────────────────────────────────────────────
#
...
in
{
  ...
  config = lib.mkIf (cfg.enable && cfg.php.enable) {
    environment.systemPackages = [
      # ────────────────────────────────────────────────────────────────────────
      # PHP Runtime
      # ────────────────────────────────────────────────────────────────────────
      # cfg.php.package resolves to the phpEnv buildEnv defined in the let block
      # in options.nix (PHP 8.3 + Xdebug + common extensions). It is exposed as
      # an option so it can be overridden per-host without editing this file.
      # ────────────────────────────────────────────────────────────────────────
      cfg.php.package
      ...
      # Composer
      # ────────────────────────────────────────────────────────────────────────
      # §COMPOSER — Must be built against the SAME PHP binary as cfg.php.package
      # This is why we derive Composer from cfg.php.package.packages.composer
      ...
      #
      # If you override cfg.php.package (option above), Composer updates
      # automatically to match — no manual coordination required.
      # ────────────────────────────────────────────────────────────────────────
      cfg.php.package.packages.composer
      ...
      # ────────────────────────────────────────────────────────────────────────
      cfg.php.package.packages.php-cs-fixer
      ...
      # ────────────────────────────────────────────────────────────────────────
      cfg.php.package.packages.psalm
      ...
      # Symfony CLI
      # ────────────────────────────────────────────────────────────────────────
      # symfony {new, serve, console, check:security}
      #
      # ────────────────────────────────────────────────────────────────────────
      ...
      #  postInstall = "wrapProgram $out/bin/symfony --set PATH ${cfg.php.package}/bin";
      #})
      # ────────────────────────────────────────────────────────────────────────
      pkgs.symfony-cli
      ...
      # ────────────────────────────────────────────────────────────────────────
      cfg.php.package.packages.php-codesniffer
      ...
      # ────────────────────────────────────────────────────────────────────────
      cfg.php.package.packages.phpmd
    ...
    # ──────────────────────────────────────────────────────────────────────────
    environment.shellInit = lib.mkIf cfg.php.withComposerGlobalPath ''
    ...
    #
    # 1. LSP:       Phpactor (installed above) via nvim-lspconfig 'phpactor'
    #               server. No Mason/npm required — phpactor is on system PATH.
    #
...
# ──────────────────────────────────────────────────────────────────────────────
# RFC: IMPLEMENTING PHP SUPPORT IN CYPHER IDE
# ──────────────────────────────────────────────────────────────────────────────
