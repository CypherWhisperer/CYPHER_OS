# ──────────────────────────────────────────────────────────────────────────────
# src/pkgs/dev/arduino/system.nix
# ──────────────────────────────────────────────────────────────────────────────
# ──────────────────────────────────────────────────────────────────────────────
# WHAT THIS FILE OWNS:
# ──────────────────────────────────────────────────────────────────────────────
...
#
#   For that merge to see the arduino-cli rules, the package must be reachable
#   at system activation time — which means it must appear in
#   environment.systemPackages or a similar system-level derivation. It is also
#   installed in hm.nix (user PATH) for day-to-day CLI use; the duplication is
#   intentional and harmless — Nix deduplicates the store path.
#
# ──────────────────────────────────────────────────────────────────────────────
...
in
{
  ...
  config = lib.mkIf (cfg.enable && cfg.arduino.enable) {
    ...
    environment.systemPackages =
      with pkgs;
      [ arduino-cli ]
      ++ lib.optionals cfg.arduino.ide.enable [ arduino-ide ]
      ++ lib.optionals cfg.arduino.ota.enable [ arduinoOTA ];
